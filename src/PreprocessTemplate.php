...
class PreprocessTemplate {
   ...
   */
    ...
    // * (de plus le template est mal concus, attributes n'est pas definie, d'ou
    // obligation de creer un fichier template ).
    // * Il faut creer un module pour palier à cela.
    // */
    // elseif ($hook == "views_bootstrap_cards" || $hook ==
    // 'view_formatter_layouts_default') {
    // $variables['attributes']['class'][] = 'custom-card-group';
    // // dump($variables);
    // } elseif ($hook == 'maintenance_page') {
    // $variables['page']['before_content']['static_image'][] =
    // $this->buildMaintenancePage($theme_name);
    // $variables['page']['before_content']['static_image']['#attached']['library'][]
    // = $theme_name . '/maintenance_page';
    // // dump($variables);
    // } elseif ($hook == 'html' && isset($variables["page"]["#theme"]) &&
