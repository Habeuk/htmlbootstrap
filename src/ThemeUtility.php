...
class ThemeUtility
{
    ...
    /**
     * Lors de la mise à jour via ajax, la nouvelle données doit etre inserer dans #value;
     *
     * @var boolean
     */
    ...
    public function addUrlTree($name, &$form, $title, $default)
    {
        ...
        $form[$name]['link'] = [
            '#type' => 'textfield', // 'url' ce type a un validateur et n'offre pas un avantage par rapport à text.
            '#title' => 'Url',
